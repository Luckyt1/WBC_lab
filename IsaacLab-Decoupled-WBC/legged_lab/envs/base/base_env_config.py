...
class BaseEnvCfg:
    ...
    commands: CommandsCfg = CommandsCfg(
        ...
        # Among moving environments, split heading feedback and direct yaw equally.
        # Half of the direct-yaw group receives an exact zero yaw-rate command.
        rel_heading_envs=0.5,
        rel_zero_vel_yaw_envs=0.5,
        heading_command=True,
        heading_control_stiffness=0.5,
        debug_vis=True,
        ranges=CommandRangesCfg(
            lin_vel_x=(-0.5, 0.5), lin_vel_y=(-0.5, 0.5), ang_vel_z=(-1.57, 1.57), heading=(-math.pi, math.pi),
            body_height=(0.35, 0.8), body_roll=(-0.7, 0.7), body_pitch=(-0.52, 1.57), body_yaw=(-1.57, 1.57)
        ),
    )
